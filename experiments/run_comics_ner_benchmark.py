...
def main():
    ...
    gliner_extractor = GLiNEREntityExtractor(model_id="fastino/gliner2-base-v1")
    ...
    save_results(gliner_result, gliner_metrics, output_dir / "gliner_comics_ner_results.json")
